...
function Video() {
  ...
  return (
    <div>
      ...
      <AdUnit></AdUnit>
      <Footer></Footer>
      <Body title="Video" linkDestination="/" linkText="Home">
        <p>
        ...
        <p>
          ...
          silver beet broccoli kombu beet greens fava bean potato quandong
          celery. Bunya nuts black-eyed pea prairie turnip leek lentil turnip
          greens parsnip.
        </p>
        <p>
          Sea lettuce lettuce water chestnut eggplant winter purslane fennel
          azuki bean earthnut pea sierra leone bologi leek soko chicory celtuce
          parsley jícama salsify. Celery quandong swiss chard chicory earthnut
          pea potato. Salsify taro catsear garlic gram celery bitterleaf wattle
          seed collard greens nori. Grape wattle seed kombu beetroot horseradish
          ...
          avocado quandong fennel gumbo black-eyed pea.
        </p>
        <p>
          Grape silver beet watercress potato tigernut corn groundnut. Chickweed
